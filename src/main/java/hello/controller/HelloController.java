...
/**
 * REST controller that handles HTTP requests for time and topic operations.
 * Provides endpoints for datetime operations, string operations, and file operations.
 */
@RestController
public class HelloController {
    ...
    String findParticularFileInPathAndSortTemplate = "----------Find File in present directory which " +
            "strats with \"grad\",provided maximum depth=25 and sort : ";
    String findParticularFileInPathAndSortWithWalkFunctionTemplate = "----------Find File in present " +
            "directory which strats with \"grad\",provided maximum depth=25 and sort :  with walk function";
    String readFileWithStreamFunctionTemplate = "---------Read \"temp.txt\" file with stream functions, " +
            "having \"print\" witin it:  ";
